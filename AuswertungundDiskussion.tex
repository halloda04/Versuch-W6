...
Es wurde für die Quecksilbersäule eine Höhe von 953,0mb und für die Kuppel eine Höhe von 1,2 mb gemessen. Die Raumtemperatur war $(21,1 \pm0,1)~^\circ\mathrm{C}$. Für die Geographische Lage von Augsburg wurde eine Höhenlage von 500m, eine östliche Länge von 10° 52 min und eine nördliche Breite von 48° 21 min verwendet. Mit diesen Werten lässt sich die gemessene Quecksilbersäure korrigieren. 
...
Damit Ergibt sich ein wahrer Atmosphärendruck von $p_0 = 950,30mb = 95030$ Pa. Hier wird angenommen das keine weiteren Fehler gemacht wurden und somit Auf die Fehlerrechnung verzichtet. Die Steighöhe der Quecksilbersäule ist im folgendem
...
gegen die ensprechende Temperatur aufgetragen. Bei dieser Messung gibt es einige Fehlerquellen. Die wohl größte ist die Bestimmung des Zeitpunkts an dem das Wasser zu kochen beginnt. Dieser wurde bei der Durchführung als der Zeitpunkt definiert an dem am gesamten Rand des Gefäßes Luftblasen zu sehen wahren, sich also an mehrern Siedesteinchen Blasen bilden. Trotz dieser Definition muss dieser Zeitpunkt immer noch Subjektiv festgestellt werden. Die Tempertur und der Druck muss dann zeitgleich abgelesen werden. Beides ist Fehleranfällig. Eine weitere Fehlerquelle ist das Ablesen der Höhe der Quecksilbersäule. Hier wird zum einen die Höhe der Kuppel nicht berücksichtigt, zum anderen muss die Höhe an einer Milimeterskala abgelesen werden was ebenfalls Fehleranfällig ist. Aus diesen Gründen die Höhe ein Messfehler von $\pm 3mm$. Der Fehler der Temperatur ensteht dadurch das Display nur eine Nachkommastellen anzeigen kann.\\
Durch die Differenz von dem Außendruck und dem Druck im Gefäß lässt sich der Dampfdruck $p_D$ betrachten. Betrachtet man aber zuerst den Druck $p$
...
Wenn man diese Werte in Abbildung \ref{gl:5} eintägt,
...
kann man eine leichte Abweichung von den Messwerten, die mit steigenden Tempearturen zunimmt, beobachtet werden. Ein Grund könnte möglicherweise das die Steighöhe der Quecksilbersäule von der Temperatur oder Druck im System, noch wegen anderen Gründen abhängig ist.
...
Nach Einsetzen der Werte ist die aus den Messwerten resultierende molare Verdampfungswärme für Wasser durch
\begin{equation}
r \approx (40.07 \pm 2.47)~\mathrm{kJ/mol}
\end{equation}
gegeben. Der Literatur Wert aus \cite{Tipler} beträgt $r_L = 40,66 \mathrm{kJ/mol}$. Somit ist die bestimmte Verdampfungswärme $r$ in der Fehlerschranke, die durch $\Delta r$ gegeben ist. 
